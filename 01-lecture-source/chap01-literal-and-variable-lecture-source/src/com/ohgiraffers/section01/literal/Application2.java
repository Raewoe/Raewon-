...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        /* 1-2. 실수와 실수의 연산 */
        /* 실수끼리의 연산도 수학에서 사칙연산에 나머지를 구하는 연산을 사용할 수 있다 */
        ...
        /* 1-3 정수와 실수의 연산 */
        /* 정수와 실수의 연산도 수학에서 사용하는 사친연산에 나머지를 구하는 연산을 사용할 수 있다 */
        ...
        /* 지금은 계산 결과가 왜 이렇게 나왔는지 보다 연산이 가능하다는 것에 지중하자 */
        ...
        * 컴퓨처는 문자를 인식하지 못하고 숫자로만 인식할 수 있기 때문에 모든 문자에 대응되는 숫자들과 매칭되어있다.
        * 아스키코드와 유니코드
        *  */
        ...
        /* 단,결과는 실수 형태로 나오게 된다(위에서 했던 정수와 실수의 연산 결과를 생각해보자 */
        ...
        /* 이유는 위에서 테스트 해본 */
        System.out.println("=========논리값과 문자열과 연산==========");
