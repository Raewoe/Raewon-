...
public class Application1 {
    ...
    public static void main(String[] args){
        ...
        * */
        ...
        System.out.println("보너스를 포함한 급여 : " +(salary + bonus) + "원"); //보기 편하고 값이 변했을때 확인하기가 편하다.
        ...
        System.out.println("1번의 고객에게 포인트를" + point +  "지급하였습니다.");
        System.out.println("2번의 고객에게 포인트를" + point +  "지급하였습니다.");
        System.out.println("3번의 고객에게 포인트를" + point +  "지급하였습니다.");
        System.out.println("4번의 고객에게 포인트를" + point +  "지급하였습니다.");
        System.out.println("5번의 고객에게 포인트를" + point +  "지급하였습니다.");
        System.out.println("6번의 고객에게 포인트를" + point +  "지급하였습니다.");
        System.out.println("7번의 고객에게 포인트를" + point +  "지급하였습니다.");
        System.out.println("8번의 고객에게 포인트를" + point +  "지급하였습니다.");
        System.out.println("9번의 고객에게 포인트를" + point +  "지급하였습니다.");
        System.out.println("10번의 고객에게 포인트를" + point +  "지급하였습니다.");
