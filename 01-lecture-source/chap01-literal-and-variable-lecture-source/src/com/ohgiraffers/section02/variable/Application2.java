...
public class Application2 {
    ...
    public static void main(String[] args){
        ...
        * */
        ...
        //lnum = 8;   //-9223342036854775808 ~ 9223372036854775807 // 아무 문제 없을 것 같지만 뒤에 대문자 L을 붙여야합니다.
        lnum = 8L;

        /* 2-2. 실수를 취급하는 자료형 값 대입 */
        //fnum = 4.0;   //실수 뒤에는 f를 붙여주어야 한다.(대문자도 가능하지만 대게 소문자를 사용한다.)
        ...
        * */
        ...
        System.out.println("isTrue의 값 출력 : " + isTrue);   //변수값 false로 변경됨
