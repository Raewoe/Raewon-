...
public class Application3 {
    ...
    public static void main(String[] args){
        ...
        /* 변수의 명명 규칙
        * 면수의 이름을 지을 때 아무렇게나 짓는 것이 아닌 정해진 규칙이 있다.
        * 실무적으로는 굉장히 주요하기 때문에 반드지 숙지해야 하고
        * 또한, 규칙에 맞는 올바른 변수명을 짓는 좋은 프로그래밍을 하는 첫 단추이다.
        * */
        ...
        * */
        ...
        //int a@ge = 20;   //사용 가능한 특수문자 외에는 사용이 불가능함
        int _age = 20;     //어디에든 사용이 가능함
        int ag$e = 20;     //가능함

        /* 2. 컴파일 에러를 발생시키지는 않지만 개발자끼리의 암묵적인 규칙 */
        /* 2-1. 변수명으로 길이제한은 없다. 하지만 적당히 하자 */

        int assadlkfjlkasdjglknsdlkgnsdalkjgflksdjfklsdjl;   //적당히 하자
        ...
        String s;
        String name;   //문자열 형태의 이름이 저장되겠구나를 파악할 수 있다.
        ...
        /* 2-8. boolean 형은 의문문으로 가급적 긍정상태로 네이밍한다. */

        boolean isAlive = true;
        boolean isDead = false;   //부정형보다 긍정형이 더 나은 방법이다.
