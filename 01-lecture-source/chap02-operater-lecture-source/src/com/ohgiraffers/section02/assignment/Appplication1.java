...
public class Appplication1 {
    ...
    public static void main(String[] args){
        ...
        * '/=: : 왼쪽의 피연산자에 오른쪽의 피연산자를 나눈 결과를 왼쪽 피연산자에 대입함
        * '%=' : 왼족의 피연산자에 오른쪽의 피연산자를 나눈 나머지 결과를 왼쪽 피연산자에 대입함
        * */
        ...
        //3증가시
        num = num + 3;      //대입연사자의 오른쪽은 값 왼쪽에는 공간의 의미이다.
        System.out.println("num : " + num);

        num += 3;          //num = num + 3; 와 같은 의미다.
        System.out.println("num : " + num);

        num -= 5;          //num = num - 5; 와 같은 의미다.
        System.out.println("num : " + num);

        num *= 2;          //num = num * 2; 와 같은 의미다.
        System.out.println("num : " + num);

        num /= 2;          //num = num / 2; 와 같은 의미다.
        System.out.println("num : " + num);

        num %= 3;          //num = num % 2' 와 같은 의미다.
        System.out.println("num : " + num);
