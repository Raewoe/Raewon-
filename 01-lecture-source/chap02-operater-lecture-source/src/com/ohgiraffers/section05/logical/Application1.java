...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        *  1-1. &&(논리AND) 연산자 : 구 개의 논리식이 모두 참일 경우 참을 반환 둘 중에 한 개라도 거짓인 경우 거짓을 반환하는 연산자이다.
        * ||(논리OR) 연산자 : 두 개의 논리식 중 둘 중 하나라도 참인 경우 참을 반환 둘 다 거짓일 경우 거짓을 반환하는 연산자이다.
        * 2. 논리 부정 연산자 : 피연산자가 하나인 단함연사자로, 피연산자의 결함 방향은 왼쪽에서 오른쪽이다.
