...
public class A_if {
    ...
    public void testSimpleIfStatement() {
         ...
         * if문은 조건식 결과 값이 참(true)이면 {}안에 코드가 실행하고,
         * 조건식의 결과가 거짓(false)이면 {}안에 코드를 무시하고 넘어감
         * */
        ...
        System.out.println("정수 숫자 한 개를 입력하세요 : ");
        int num = sc.nextInt();
    ...
    public void testNestedIfStatement() {
         ...
         * 둥 중 하나라도 해당하지 않으면 아무 내용도 출력하지 않는 구문을 작성해보자
         * 단, 조건과 상관없이 프로그램이 종료될 때 "프로그램 종료합니다"라고 출력 되도록 한다.
         * */
