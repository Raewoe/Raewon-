...
public class C_ifElseif {
    ...
    public void testSimpleIfElseIfStatement() {
        ...
        if (answer == 1) {
            ...
            System.out.println("욕심이 과하지는 않지만 그래도 너는 거짓말을 하고 있구나! 꺼지거라");

        } else {
            System.out.println("너는 정직하구나 여기 있는 모든 도끼를 가져가거라");
        }
    ...
    public void testNestedIfElseIfStatement () {
        ...
        int an = sc.nextInt();
        if (an > 90) {
            System.out.println("학생의 점수는 " + "점이며 학생은 A입니다");
        }else if(an > 80) {
            System.out.println("학생의 점수는 " + "점이며 학생은 B입니다");
        }else if(an > 70) {
            System.out.println("학생의 점수는 " + "점이며 학생은 C입니다");
        }else if(an > 60){
            System.out.println("학생의 점수는 " + "점이며 학생은 D입니다");
        }
