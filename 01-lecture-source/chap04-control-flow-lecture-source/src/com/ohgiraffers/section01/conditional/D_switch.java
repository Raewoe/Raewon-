...
public class D_switch {
    ...
    public void testSimpleSeitchStatement() {
         ...
         * 따라서 일부 호환이 가능하다
         * 하지만 switch문으로 비교 사능한 값은 정수, 문자, 문자열 형태의 값이다.
         * 실수와 논리는 비교할 수 없다.
         * 또한 정확하게 일치하는 경우만 비교할 수 있으며 대소 비교를 할 수 없다는 것이 차이입니다.
    ...
    public void testSwitchVendingMachine() {
        ...
        /*
        * 1. JDK1.7 이상부터 switch문을 사용하여 문자열을 비교할 수 있다.
