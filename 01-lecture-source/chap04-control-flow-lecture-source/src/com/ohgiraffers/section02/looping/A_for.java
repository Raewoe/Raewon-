...
public class A_for {
    ...
    public void testSimpleForStatement() {
        ...
        /* 수업목표. for 단돈 사용에 대한 흐름을 이해하고 적용할 수 있다.
         *
         * [for문 표현식]
         * for(초기식; 조건식; 증감식;) {
        ...
        for (; j2 <= 15; ) {
            System.out.println(j);
            j2++;
        }     //(int i = 1;(초기식) i <= 10;(조건식) i++(증감식)) 위에 처럼 초기식과 증감식은 밖으로 나와도 되지만 조건식은 나올 수 없다.
    ...
    public void testForExample1() {
        ...
        for (int i = 1; i <= 10; i++) {
            ...
            System.out.println(i + "명의 학생의 이름은 " + student + "입니다.");
    ...
    public void printSimpleGugudan() {
        ...
        * 2~9사이에 경우 해당 단의 구구단의 출력하고
        * 그렇지 않은 경우 "반드지 2~9 사이의 양수를 입력해야합니다." 출력
        * */
