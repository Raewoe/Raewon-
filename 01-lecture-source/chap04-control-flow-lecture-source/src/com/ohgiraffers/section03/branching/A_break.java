...
public class A_break {
    ...
    public void testSimpleBreakStatememt() {

        /* 수업목표. break문 사용에 대한 흐름을 이해하고 적용할 수 있다. */
        /*
         * break문은 반복문 내에서 사용한다.
         * 해당 반복문을 빠져 나로 때 사용하며, 반복문의 조건문 판단 결과와 상관없이 반복문을 빠져나올 때 사용한다.
         * 일번적으로 if(조건식) {break;} 처럼 사용한다.
    ...
    public void testSimpleBreakStatement2() {
        ...
        /*
         * 구구단 2~9단까지 출력
         * 단, 각 단수의 수가 5보다 큰 경우 해당 반복문을 빠져나온다.(출력을 생략한다.)
         * */
