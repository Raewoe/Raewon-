...
public class Application {
    ...
    public static void main(String[] args) {
         ...
         * 사용자 정의 자료형인 클래스를 이용하기 위해서느 new 연산자로 heap에 할당해야한다.
         * 객체를 생성하게 되면 클래스에 정의한 필드와 메소드 대로 객체가 생성된다.
         * 아이디.비밀번호,이름,나이,성별,취미를 연손된 메모리 주소에 사용하도록 heap에 광간을 만들었다.
         * */

        Member member = new Member();   //객체 생성(사용의 정의 변수명)

        /* 2-2. 생성된 인스턴스 최기값 확인하기 */
        /*
         * 필드에 접근을 하기 위해서는 래퍼런스변수명.필드명
         * '.' 참조연산자라고 하는데 래퍼런스 변수가 참고하고 있는 주소로 접근하다는 의미를 가진다.
         * 각 공간은 필드명으로 접근한다. ()*/
        ...
        member.age = 15;
        member.gender = '남';
        member.hobby = new String[]{"축구","야구","배우"};
