...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        * 현실게계를 프로그램의 목적에 맞게 단순화하는 추상화라는 기법을 적용하게 된다
        * */

        /*
        * 추상화란?
        * 공통된 부분을 추출하고 공동되지 않은 부분을 제거한다는 의미를 가지며, 추상화의 목적은 유연성을
        * 확보하기 위함이다. 유연성 확보는 여러곳에 적용할 수 있는 유일한 객체를 의미하며 즉, 재사용성이 높아질 수 있다는
        * 의미이다. 객체의 재사용성이 증가하면 중복 작성되는 코드를 줄일 수 있으면, 오류 발생 기능성을
        * 감소기키고 유지 보수성을 증가시킨다.
        * */
        ...
        *  - 사용자, 카레이서, 자동차
        * 2. 객제간의 상호작용
        *  - 카레이서가 수실 할 수 있는 메세지(카레이서가 해야하는일)
        * 1. 시동을 걸어라
        * 2. 엑셀을 밞아라
        * 3. 브레이크를 밞아라
        * 4.시동을 꺼라
        ...
        * 1. 카레이서 클래스
        *  - 속성 : 자동차
        *  - 행위 : 시동을 걸어라, 엑셀을 밞아라, 브레이크를 밞아라, 시동을 꺼라
        * 2. 자동차 클래스
        *  - 속성 : 시동상태, 현재시속
