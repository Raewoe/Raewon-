...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* 수업목표. 데이터를 차상화하는 기법을 이해하고 이를 사용하여 프로그래밍 할 수 있다 */
        ...
        menber.setAge(20);
        menber.setGender('남');
        menber.setHeight(188);
        menber.setActivated(true);

        System.out.println("회원번호 : " + menber.getNumber());
        System.out.println("회원이름 : " + menber.getName());
        System.out.println("나이 : " + menber.getAge());
        System.out.println("성별 : " + menber.getGender());
        System.out.println(" 키 : " + menber.getHeight());
        System.out.println("활성화상태 : " + menber.isActivated());
