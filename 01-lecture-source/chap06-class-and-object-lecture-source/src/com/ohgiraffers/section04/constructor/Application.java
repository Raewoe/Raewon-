...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* 생성자란?
         * 인스턴스를 생성할 때 조기 수행할 명령이 있는 경우 미리 작성해두고, 인스턴스를 생성할 때 호출한다.
        ...
        User user1 = new User();
        System.out.println(user1.getInformaiion());

        /**/

        User user2 = new User("user01", "pwd01", "이래원");
        System.out.println(user2.getInformaiion());
