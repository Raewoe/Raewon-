...
public class FinalFieldTest {
    ...
    * */
    ...
    /* 2. static final에 final 사용 */
    /*
    * static에서도 자바에서 저장한 기본값이 대입되기때문에 final키워드 사용시 초기화를 하지 않으면 에러가 발생한다.
    * */

    //public static final int STATIC_NUM;          //에러발생 , 0으로 초기화 되기 때문에 이후 값 변경 불가
    ...
    * 하지만 static은 프로그램이 시작할 때 할당되기 때문에 초기화 되지 않은 상태로 선언된 것과 동일하여
    * 기본값으로 초기화된 이후 값을 변경하지 못 하기 때문에 에러가 발생한다.
    * */
