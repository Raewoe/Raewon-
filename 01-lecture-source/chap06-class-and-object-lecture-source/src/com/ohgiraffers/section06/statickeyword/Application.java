...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        * 하지만 static키워드의 남발은 유지보수와 추적이 힘든 코드를 작성하는 방법은 피해야할 방식이다.
        * 명확한 목적이 존재하지 않는 이상 static키워드 사용은 자제하자
        * 의도적으로 static키워드를 사용하는 대표적인 예는 singleton 객체를 생성할 때이다.
        * */

        /* 1. static키워드를 필드에서 사용 */
        ...
        * 인스턴스를 생성할 때마다 0으로ㅗ 초기화 되었다.
        * static 필드의 경우에는 클래스 변수 자체가 프로그램이 종료할 때까지 유지되고 있기 때문에
        * 값을 유지하고 있다.
        * 따라서 여려 개의 인스턴스가 같은 값(공간)을 공유할 목적으로 static 키워드를 사용한다.
        *  */
