...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* 초기화 블러의 동작 순서를 이해하고 이를 활용하여 인스턴스를 생성할 수 있다. */
        /*
        * 초기화 블러이란?
        ...
        *     인스천스 변수를 초기화하며 정적필드에는 실행시마다 값을 덮어쓴다.
        * {
        *     초기화 내용작성
        * }
        * 2. 정적 초기화 블러
        *   : 클래스가 로드될 때 한 번 동작한다.
        *     정적필드를 초기화하며, 인스턴스 변수는 초기화 하지 못 한다.
        * static{
        *     초기화 내용 작성
        * }
        * */
        ...
        //System.out.println("pro.getInformation() = " + pro.getInformation());

        /* 2. 명시적 초기화로 필드 초기화 확인 */
        System.out.println("pro.getInformation() = " + pro.getInformation());

        /* 3. 초기화 블럭으로 필드 초기화 확인 */
        System.out.println("초기화 블럭 pro.getInformation() = " + pro.getInformation());

        /* 4. 매개변수 있는 생성자를 이용한 초기화 확인 */
        Product product1 = new Product("대륙폰", 30000, "샤오미");
