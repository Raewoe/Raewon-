...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        MemberService menberSerivce = new MemberService();
        ...
        while (true) {
            ...
            switch (no) {
                case 1 : menberSerivce.signUpMember(); break;
                case 2 : menberSerivce.showAllMember(); break;
                case 9 : System.out.println("프로그램을 종료합니다."); return;
                default: System.out.println("잘못된 번호를 입력하였습니다."); return;
