...
public class Application {
    public static void main(String[] args) {
        ...
        /*
         * super : 자식 클래래스를 이용해서 객체를 생성할 때 부모 생성자를 호출하여 부모 클래스의
         *         인스턴스도 함께 생성하게 된다. 이 때 생성한 부모의 인스턴스 주소를 보관하는
         *         래퍼런스 변수로 자식 클래스 내의 모든 생성자와 메소드 내에서 선언하지 않고도 사용할
         *         수 있는 래퍼런스 변수이다.
         * super() : 부모 생성자를 호출하는 구문으로 인자외 매개변수 타입, 갯수, 순서가 일치하는
         *           부모 생성자를 호출하게 된다. this()가 해당 클래스 내에 다른 생성자를 호출하는
         *           구문이라면 super()는 부모 클래스가 가지는 Private 생성자를 제외한 너머지
       ...
       Product product1  = new Product();
        ...
        Product product2 = new Product("s-01234", "삼성", "갤럭시", 3590000, new Date());
        ...
        Computer computer3 = new Computer("s-2", "삼성", "갤럭시 폴드", 259000, new Date(), "퀄컴", 512, 12, "안드로이드");
