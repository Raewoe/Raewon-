...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /*
         * 추상 클래스와 추상 메소드
         * 추상 메소드를 0개 이상 포함하는 클래스를 추상 클래스라고한다.
         * 추상 클래스는 클래스 선언부 abstract 키워드를 명시해야한다.
         * 추상 클래스로는 인스턴스 생성이 불가능하다.
         * 추상클래슨를 사용하려면 추상클래스 상속 받는 하위클래스를 이용하여 인스턴스를 생성해야한다.
         * 이 때 추상클래스는 상위 타입으로 사용될 수 있으며 다형성을 이용할 수 있다.
         * */

        /*
         * 추상클래스에 작성된 추상 메소드는 반드시 후손이 오버라이딩해서 작성해야하며
        ...
        * 그래서 추상 클래스보다 더 강제성이 강한 인터페이스라는 매커니즘을 제공하고 있다.
        * */
