...
public interface InterProduct extends java.io.Serializable/*, java.util.Comparator*/ {
    ...
    /*
    * 인터페이스가 인터페으스를 상속받을 시에는 extends 키워드를 사용하며
    * 이때는 여러 인터페이스를 다중 상속 받을 수 있다.
    * */

    /*
    * 인터페이스는 상수 필드만 작성 가능하다.
    * punlic static final 제어자 조합을 상수 필드라고 부른다.
    ...
    * */
    ...
    /* 인터페이스는 구현부가ㅏ 없는 nonstatic 메소드를 가질 수 없다. */
    ...
    /*
    * 인터페이스 안에 작성한 메소드는 묵시적으로 public asdtract의 의미를 가진다.(다른 접근제한자 사용불가)
    * 따라서 인터페이스 메소드를 오버라이딩 하는 경우
    * 반드시 접근제한자를 public으로 오버라이딩이 가능하다.
    * */
    ...
    /* default 키워드를 사용하면 nonstatic 메소드도 작성 가능하다.(JDK 1.8에 추가된 기능) */
