...
public class Application1 {
    public static void main(String[] args) {
        ...
        /*
        * charAt() : 해당 문자열의 인덱스에 해당하는 문자를 변환한다.
        ...
        * */
        ...
        /* concat() : 문자열에 인자로 전달한 문자열을 합치기 해서 새로운 문자열을 반환하다.
        * 원본 문자열에는 영향을 주지 않는다.
        * */
        ...
        * */
        ...
        System.out.println("indexOf('z') : " + indexOf.indexOf('z'));   //-1 ,일치하는 문자가 없음

        /*
        * lastIndexOf() : 문자열 탐색을 뒤에서부터하고 처음 일치하는 위치를 인덱스를 반환한다.
        * 단, 일치하는 문자가 없는 경우 -1을 반환한다.
        * */
