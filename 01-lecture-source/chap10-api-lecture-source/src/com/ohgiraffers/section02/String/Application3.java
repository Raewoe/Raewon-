...
public class Application3 {
    public static void main(String[] args) {
        ...
        /* 문자열 분리에 대해 이해하고 반환하는 기능을 한다.
        * split(0 : 정규표현식을 이용하여 문자열을 분리한다.
        ...
        * */
        ...
        String emp1 = "100/이래원/서울/영업1팀";       //모든 값이 존대
        String emp2 = "200/이래//영업2팀";            //주소 없음
        String emp3 = "300/이원/부산/";               //부서 없음
        ...
        StringTokenizer color2 = new StringTokenizer(colorStr, "*#/ ");

        while (color2.hasMoreTokens()) {
            System.out.println(color2.nextToken());
        }
