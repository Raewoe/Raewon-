...
public class Application2 {
    public static void main(String[] args) {
        ...
        /* 수업목표. Stringbuilder의 자주 사용되는 메소드의 활용법을 확인 할 수 있다. */
        
        StringBuilder sb1 = new StringBuilder();
        
        /* capcity() : 용량(현재 퍼버의 크기)을 정수형으로 반환하는 메소드(문자열 길이 + 16 기본용량) */
        ...
        * */
        ...
        System.out.println("sb2 = " + sb2);      //원본에 영향을 줌
        ...
        /* 인데스 번호가 문자열 길이와 같은 경우 append()와 같은 역할을 한다. */
