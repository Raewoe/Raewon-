...
public class Application1 {
    public static void main(String[] args) {
        ...
        /*
        * 상황에 따라 기본타입의 데이처를 인스턴스화해야 하는 경우가 발생한다.
        * 이때 기본타입의 데이터를 먼저 인스턴스로 변환 후 사용해야하는데
        * 8가지에 해당하는 기본타입의 데이터를 인스턴스화 할 수 있도록 하는 클래스를 레퍼클래스라고한다.
        * (주방에서 사용하는 랩과 같은 형태로 감싼다는 뜻이다.)
        * */
        ...
        * 이런 자동화된 박싱과 언박싱을 오토박싱과 오토 언박싱이라고 한다.
        * */
        ...
        System.out.println("valuOf() : " + (Integer.valueOf(123)== Integer.valueOf(123)));   //box을 할 때 권장함
