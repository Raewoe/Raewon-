...
public class Application2 {
    public static void main(String[] args) {
        ...
        * 따리서 Calender 클래스를 이용해서 인스턴스를 생성하는 것이 불가능하다.
        * */
        
        /* Calender 클래스를 이용한 인스턴스 생성 방법에는 크게 두 가지가 있다.
        * 1. getInstance() static 메소드를 이용해서 인스턴스를 반환받는 방법
        * 2. 후소 클래스 GregorianCalender 클래스를 이용하여 인스턴스를 생서하는 방법
        * */
        ...
        Calendar gregotianCalender = new GregorianCalendar();

        System.out.println("gregotianCalender = " + gregotianCalender);
        
        int year = 2014;
        int month = 8;   //0월부터 11월까지 사용하기 때문에 8은 9월을 의미한다.
        int dayOfMonth = 18;
        int hour = 16;
        int min = 42;
        int second = 0;
