...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 2. Vector, ArryList, LinkedList, Stack, Queue 등이 있다.
        * 3. 요소의 저장 순서가 유지된다.
        * */

        /* ArrayList
        * 배열의 단점을 보완하기 위해 만들어졌다.
        * 배열은 크기를 변경할 수 없고 요소의 추가, 삭제, 정렬등이 복잡하다는 단점이 있다.
        * 이러한 배열의 단점을 보완하고자
        ...
        * */
        ...
        /* 제네릭 타입을 지정하면 지정된 타입 외에는 인스턴스는 지정하지 못한다. */
        ...
        strings.add("orange");
        strings.add("mango");
        strings.add("strowberry");

        System.out.println("strings = " + strings);

        /* 컬렉션 인터페이스가 아니고 컬렉션스 클래스이고 static 메소드이다.
        ...
        * 하지마 기본적으로 ArrayList는 기능을 제공하지 않는다.
        ...
        * */
        ...
        /*
        * Itreator 반복자 언터페이스를 활용해서 역순으로 정렬한다.
        * LinkedList 타입으로 형변환 후 descendingIteator() 메소드를 사용하면
