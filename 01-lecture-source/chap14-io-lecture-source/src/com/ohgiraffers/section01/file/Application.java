...
public class Application {
    public static void main(String[] args) {
        ...
        * 대상 파일에 대한 정보로 인스턴스 생성하고 파일의 생성, 삭세 등등의
        ...
        * */
        ...
        System.out.println("파일의 절대 경로 : " + file.getAbsoluteFile());      //text 창 만들어짐

        boolean deleteSuccess = file.delete();

        System.out.println("deleteSuccess = " + deleteSuccess);               //text 창 지워버림
